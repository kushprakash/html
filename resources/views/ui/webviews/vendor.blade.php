...
<section class="about-page section-b-space">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="banner-section"><img src="{{asset('assets/images/vendor/profile.jpg')}}"
        ...
        <div class="row">
            <div class="col-lg-12">
                 <div class="vendor-top" >
                    <!--<h3>Vendor On-boarding Details</h3>-->
                    <!--<p>1. Kindly fill all the relevant details.</p>-->
                    <!--<p>2. Response is mandatory else form will not be submitted</p>-->
                    <!--<p>3. Mention 'NA' wherever not applicable.</p>-->
                    <!--<h6>The name and photo associated with your Google Account will be recorded when you upload files and submit this form. </h6>-->
                    
                    <form  action="{{url('become-vendor-submit')}}" id="" method="post" enctype="multipart/form-data" onsubmit="return myFun()">
...
<option value="West Bengal">West Bengal</option>
                                ...
                                <div class="form-group">
                                    <label>District</label>
    									<select required id="inputDistrictss" name ="district"class="form-control">
 ...
 <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" class="form-control" name="authorized_name" required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="bank_account_number" style="" >
                                </div>
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label>IEC</label>
                                    <input  type="text"  id="e1"  class="form-control"   name="iec">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="vendon-checkbox">
                                    <input type="checkbox" name="">  1.  It is expected that the vendor should be able to process all the orders that he received before 4 PM same day and rest of the orders next day.
                                </div>
                                <div class="vendon-checkbox">
                                    <input type="checkbox" name="">  2. Regarding processing, there should be Contact Person from the vendor that will stay in touch with our operation team for smooth operation.
                                </div>
                                <div class="vendon-checkbox">
                                    <input type="checkbox" name="">  3. The vendor is expected to share their business hours which should atleast be from 10 AM to 6 PM.
                                </div>
                                <div class="vendon-checkbox">
                                    <input type="checkbox" name="">  4. The vendor will bear the packaging cost for the orders. exportindiagroup tapes (charges) will be shared. 1week prior notice is required for replenishment.
                                </div>
                                <div class="vendon-checkbox">
                                    <input type="checkbox" name="">  5. There will be a penalty of Rs 1000 in the case of expired product is dispatched to the customer. For wrong orders, the vendor shall bear the cost of reverse and re-logistics.
                                </div>
                                <div class="vendon-checkbox">
                                    <input type="checkbox" name="">  6. For any change in the inventory/price/pack size, they need to intimate exportindiagroup.com proactively.
                                </div>
                                <div class="vendon-checkbox">
                                    <input type="checkbox" name="">  7. All billing shall be computer generated and be complying to all GST norms, directly to the consumer.
                                </div>
                                <div class="vendon-checkbox">
                                    <input type="checkbox" name="">  8. Standard packaging norms should apply. No competition logo/mention should be on the packaging material.
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 read-terms-top">
...
<br><br>
            ...
            <div class="col-sm-12">
                <h4>Start your business with reach customers across the World...</h4>
