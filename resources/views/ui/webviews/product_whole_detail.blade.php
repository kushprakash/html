                    ...
                    <div class="col-lg-6 rtl-text">
                        <div class="product-right">
                            <h2>{{$product_detail->name}}</h2>
                                                    ...
                                                    <h4>₹ {{$product_detail->wholesaler_price}}</h4>
                            ...
                            <a href="#" style="color:white;" @if($productsize!=null)  onclick="addcartsized({{$productsize->id}},'wholesale',{{$product_detail->id}})" @endif data-toggle="modal" data-target="#addtocart" class="btn btn-solid">add to cart</a> 
                            <a href="{{url('checkout-form-bynowdetail/'.$product_detail->id.'/'.$productsize->id.'/'.'wholesale')}}"  class="btn btn-solid">buy now</a>
                    ...
                    <div class="container-fluid p-0">
                        <div class="row">
                            <div class="col-12">
                                            ...
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    ...
                                                    <div class="product-detail">
                                                        ...
                                                        <h4><span>₹ {{$product_detail->wholesaler_price}}</span></h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php $counte=0;?>
                                            ...
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    ...
                                                    <div class="product-detail">
                                                        ...
                                                        <h4><span>₹{{$valu22->wholesaler_price*$valu22->quantity}}</span></h4>
                                                    </div>
                                                </div>
                                            </div>
                             ...
                             @else
                             <a style="color: white;" @if($productsize!=null) onclick="addcartsized({{$productsize->id}},'wholesale',{{$product_detail->id}})" @endif data-toggle="modal" data-target="#addtocart" class="btn btn-solid">add to cart</a> <a href="#" data-toggle="modal" data-target=".bd-example-modal-lg" class="btn btn-solid">buy now</a>
                          <div class="modal fade bd-example-modal-lg theme-modal cart-modal" id="addtocart" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body modal1">
                    <div class="container-fluid p-0">
                        <div class="row">
                            ...
                            <div class="border-product">
                                ...
                                @endif
                                <?php // dd($product_detail->describtion_image);?>
                ...
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        ...
                        <div class="product-detail">
                            ...
                            <?php $size=DB::table('product_size')->where('product_id',$value4->id)->first(); $count=0;  ?>
                                            
                                            
                                              
                                        <h4>₹ {{$value4->wholesaler_price}}</h4>
