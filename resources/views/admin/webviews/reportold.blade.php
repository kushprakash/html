...
?>
					...
					<td>
						...
						<?php $dsa=DB::table('order_history')->where('order_id',$value->payment_request_id)->where('status',6)->first();?>
          
				 		@if($dsa != null)
						@if($dsa->status==6)
			 <strong>   {{$dsa->created_at}}   </strong>  
						@endif
						@endif
					</td>
	 			
		  			<td>
						<?php $dsa=DB::table('order_history')->where('order_id',$value->payment_request_id)->where('status',4)->first();?>
			 ...
			 <strong>   {{$dsa->created_at}}   </strong>  
						...
						<td>
			      <?php $dsa=DB::table('order_history')->where('order_id',$value->payment_request_id)->where('status',1)->first();?>
			 ...
			 <strong>  {{$dsa->created_at}}  </strong>  
					...
					<td>
						  <?php $dsa=DB::table('order_history')->where('order_id',$value->payment_request_id)->where('status',2)->first();?>
		...
		<td>
						  <?php $dsa=DB::table('order_history')->where('order_id',$value->payment_request_id)->where('status',3)->first();?>
