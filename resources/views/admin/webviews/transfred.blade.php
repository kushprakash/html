                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                ...
                                <li class="breadcrumb-item active">Trasfer</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="needs-validation" action="{{asset(url('admin/addtransfer'))}}" method="POST" enctype="multipart/form-data">
											@csrf
                        ...
                        <div class="table-responsive">
                            <table   class=" table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                       ...
                                       <tbody>
                                    <?php $ad=DB::table('payment_transfer')->where('deleted_at',null)->first();
									
									$ads=DB::table('payment_transfer')->where('deleted_at',null)->get();
									$price=0;
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="needs-validation" action="{{asset(url('admin/edittransfer/'.$r->id))}}" method="POST" enctype="multipart/form-data">
											@csrf
