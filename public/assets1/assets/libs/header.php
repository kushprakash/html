     ...
     <div class="container">
         <div class="header-left">
             ...
             <a href="demo3.html" class="logo">
                 <!-- <img src="assets/images/logo-black.png" alt="Porto Logo"> -->Dinkachika
             </a>
                                 ...
                                 <div class="col-lg-4 p-0">
                                     <div class="menu-banner">
                                         ...
                                         <div class="banner-content">
                                             ...
                                             <a href="shop.php" class="btn btn-sm btn-dark">SHOP
                                                 NOW</a>
                                         </div>
                                     </div>
                                 </div>
         ...
         <div class="header-right">
             ...
             <a href="login.html" class="header-icon header-icon-user" title="Login"><i class="icon-user-2"></i></a>
